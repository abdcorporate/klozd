    ...
    <section className="section-padding section-dark relative overflow-hidden">
      ...
      <div className="container-narrow relative z-10">
        <div className="text-center max-w-3xl mx-auto px-4 sm:px-6">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-primary/10 border border-primary/20 rounded-full text-primary text-xs sm:text-sm font-medium mb-4 sm:mb-6 animate-fade-in-up delay-200">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 px-2 animate-fade-in-up delay-300">
            Fais partie des <span className="text-gradient">100 pionniers.</span>
          </h2>
          
          <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto px-2 leading-relaxed animate-fade-in-up delay-400">
