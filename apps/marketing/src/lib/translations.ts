...
export const translations = {
  ...
  waitlist: {
    modal: {
      title: { fr: "Rejoindre la Waitlist", en: "Join the Waitlist" },
      description: { fr: "Rejoignez les 500 premiers utilisateurs et bénéficiez d'avantages exclusifs.", en: "Join the first 500 users and get exclusive benefits." },
      close: { fr: "Fermer", en: "Close" },
      successTitle: { fr: "C'est bon ! Vous êtes sur la waitlist.", en: "You're on the waitlist!" },
      successBody: { fr: "Nous vous recontacterons bientôt.", en: "We'll contact you soon." },
      okButton: { fr: "OK", en: "OK" },
      alreadyJoinedBody: { fr: "Vous êtes déjà inscrit.", en: "You're already on the list." },
      errorGeneric: { fr: "Erreur, réessayez.", en: "Something went wrong, please try again." },
      errorRateLimit: { fr: "Trop de tentatives, réessaie dans 1 minute.", en: "Too many attempts, try again in 1 minute." },
      errorEmailInvalid: { fr: "Email invalide.", en: "Invalid email." },
      errorNetwork: { fr: "Impossible de contacter le serveur, réessaie.", en: "Unable to reach the server, please try again." },
      successInscription: { fr: "✅ Inscription réussie", en: "✅ Successfully registered" },
      retryButton: { fr: "Réessayer", en: "Retry" },
    },
    form: {
      email: { fr: "Email", en: "Email" },
      fullName: { fr: "Nom complet", en: "Full Name" },
      industry: { fr: "Secteur d'activités", en: "Industry" },
      teamSize: { fr: "Équipe", en: "Team Size" },
      leadVolume: { fr: "Volume de leads mensuel", en: "Monthly Lead Volume" },
      revenue: { fr: "Chiffre d'affaires mensuel", en: "Monthly Revenue" },
      selectIndustry: { fr: "Sélectionner un secteur", en: "Select an industry" },
      selectTeamSize: { fr: "Sélectionner une taille", en: "Select a size" },
      selectVolume: { fr: "Sélectionner un volume", en: "Select a volume" },
      selectRevenue: { fr: "Sélectionner un CA", en: "Select revenue" },
      submit: { fr: "Rejoindre la Waitlist", en: "Join the Waitlist" },
      submitting: { fr: "Inscription en cours...", en: "Submitting..." },
      success: { fr: "Inscription réussie !", en: "Successfully registered!" },
      successMessage: { fr: "Nous vous recontacterons bientôt.", en: "We'll contact you soon." },
      error: { fr: "Erreur de connexion", en: "Connection error" },
      errorMessage: { fr: "Impossible de se connecter au serveur. Vérifiez que l'API est démarrée sur http://localhost:3001", en: "Unable to connect to server. Please check that the API is running on http://localhost:3001" },
      validationEmail: { fr: "Veuillez renseigner un email valide.", en: "Please enter a valid email." },
      disclaimer: { fr: "En vous inscrivant, vous acceptez d'être recontacté. Aucun spam.", en: "By signing up, you agree to be contacted. No spam." },
      emailPlaceholder: { fr: "votre@email.com", en: "your@email.com" },
      namePlaceholder: { fr: "Jean", en: "John" },
    },
    industries: {
      it: { fr: "IT / Technologie", en: "IT / Technology" },
      realEstate: { fr: "Immobilier", en: "Real Estate" },
      finance: { fr: "Finance / Assurance", en: "Finance / Insurance" },
      coaching: { fr: "Coaching / Formation", en: "Coaching / Training" },
      ecommerce: { fr: "E-commerce / Retail", en: "E-commerce / Retail" },
      health: { fr: "Santé / Bien-être", en: "Health / Wellness" },
      automotive: { fr: "Automobile", en: "Automotive" },
      construction: { fr: "BTP / Construction", en: "Construction" },
      consulting: { fr: "Conseil / Services", en: "Consulting / Services" },
      other: { fr: "Autre", en: "Other" },
    },
    teamSizes: {
      one: { fr: "1 personne", en: "1 person" },
      twoFive: { fr: "2 - 5 personnes", en: "2 - 5 people" },
      sixTen: { fr: "6 - 10 personnes", en: "6 - 10 people" },
      elevenTwenty: { fr: "11 - 20 personnes", en: "11 - 20 people" },
      twentyPlus: { fr: "20+ personnes", en: "20+ people" },
    },
    leadVolumes: {
      zeroFifty: { fr: "0 - 50 leads/mois", en: "0 - 50 leads/month" },
      fiftyTwoHundred: { fr: "50 - 200 leads/mois", en: "50 - 200 leads/month" },
      twoHundredFiveHundred: { fr: "200 - 500 leads/mois", en: "200 - 500 leads/month" },
      fiveHundredPlus: { fr: "500+ leads/mois", en: "500+ leads/month" },
    },
    revenues: {
      zeroFiftyK: { fr: "0 - 50k€", en: "0 - 50k€" },
      fiftyKTwoHundredK: { fr: "50k - 200k€", en: "50k - 200k€" },
      twoHundredKFiveHundredK: { fr: "200k - 500k€", en: "200k - 500k€" },
      fiveHundredKOneM: { fr: "500k - 1M€", en: "500k - 1M€" },
      oneMPlus: { fr: "1M€+", en: "1M€+" },
    },
  },
} as const;
