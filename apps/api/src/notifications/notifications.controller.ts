import { Controller, Get, Patch, Param, UseGuards, Post, Body, Query } from '@nestjs/common';
...
export class NotificationsController {
  ...
  @Get()
  @ApiOperation({ summary: 'Récupérer la liste des notifications avec pagination par curseur' })
  ...
  @ApiResponse({ status: 200, description: 'Liste paginée des notifications', type: PaginatedResponse })
  findAll(
